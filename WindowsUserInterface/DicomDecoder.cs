...
// Updated by Harsha VarianceList, Apr 2010.
...
namespace DicomImageViewer
{
    ...
    class DicomDecoder
    {
        ...
        private string[] _PN_Values;
        public string[] PN_values { get { return _PN_Values; } }
        #endregion
        ...
        List<short> pixels16;
        public short[,] pixels16Array2D;
        public byte[,] pixels8Array2D;
        public byte[,] pixels24Array2D;
       // List<int> pixels16Int;
        ...
        public void GetPixels16(ref List<short> pixels)
        {
            pixels = pixels16;
        }
        //public void GetPixels16Signed(ref List<int> pixels)
        //{
        //    pixels = pixels16Int;
        //}
        ...
        String GetHeaderInfo(int tag, String value)
        {
            ...
            switch (vr)
            {
                ...
                case DS:
                      //for (int i = 0; i < elementLength; i++)
                      //    ap_q.Enqueue(GetByte());
                      //if (!string.IsNullOrEmpty(Encoding.ASCII.GetString(ap_q.ToArray())))
                      //{
                      //    ap_q_s.Enqueue("ds    :"+Encoding.ASCII.GetString(ap_q.ToArray()));
                      //    ap_q.Clear();
                      //}
                      //break;
                ...
                //    if (!string.IsNullOrEmpty(Encoding.ASCII.GetString(ap_q.ToArray())))
                //    {
                //        ap_q_s.Enqueue(Encoding.ASCII.GetString(ap_q.ToArray()));
                //        ap_q.Clear();
                //    }
                //    break;
        ...
        public bool ReadFileInfo()
        {
            ...
            //..............addition AP
            _PN_Values = new string[ap_q_s.Count];
            _PN_Values = ap_q_s.ToArray();
        ...
        void ReadPixels()
        {
            if (samplesPerPixel == 1 &&  bitsAllocated == 8)
            {
                ...
                pixels8Array2D = new byte[width, height];
                ...
                for (int i = 0; i < numPixels; ++i)
                {
                    ...
                    pixels8Array2D[i - ((i / height) * width), ((i / height))] = (byte)(pixVal);
                   
                    pixels8.Add((byte)(pixelRepresentation == 1 ? pixVal : (pixVal)));
            ...
            if (samplesPerPixel == 1 &&  bitsAllocated == 16)
            {
             ...
             //   pixels16 = new List<ushort>();
                ...
                pixels16Array2D = new short[width, height];
                ...
                for (int i = 0; i < numPixels; ++i)
                {
                    ...
                    int a = i - ((i / width) * width);
                    int b = ((i / width));

                   if (a >= width || b >= height)
                       a = a;
                    pixels16Array2D[a,b ] = (short)(pixVal);
                   // pixels16Array2D2[g,g2] = (short)(pixVal);

                    pixels16.Add((short)pixVal);
                  ...
                  //  pixels16Array2D[((g / height)) * width, g-((g / height)*width)] = (short)(pixVal);
                }

                int minPixVal = pixels16.Min();
                signedImage = false;
                ...
                //    //if (signedImage)
                //    //    pixels16.Add((short)(pixel - min16));
                //    //else
                //        pixels16.Add((short)(pixel));
                //}

                //for(int i=0;i<pixels16Array2D.GetLength(0);i++)
                //    for (int j = 0; j < pixels16Array2D.GetLength(1); j++)
                //    {
                //        pixels16Array2D[i, j] = pixels16Array2D[i, j];
                //    }
            ...
            if (samplesPerPixel == 3 && bitsAllocated == 8)
            {
                ...
                //This part should be corrected for R and G and B.
                minValue = int.MaxValue;
                maxValue = int.MinValue;
                ...
                {
                    pixels24.Add(buf[i]);
                    pixels24Array2D[i - ((i / height) * width), ((i / height))] = (byte)(buf[i]);

                    if (buf[1] < minValue)   // Only the red component is taken into account. Other components should be taken into account.
                        minValue = buf[1];
                    if (buf[1] > maxValue)
                        maxValue = buf[1];
